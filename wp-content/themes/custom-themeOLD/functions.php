...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('news-home', 500, 330, true); // News Home
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('lightbox', get_template_directory_uri() . '/js/lightgallery.min.js', array('jquery'), '1.0.0', true);
        ...
        wp_register_script('html5blankscripts', get_template_directory_uri() . '/js/scripts.js', array('jquery'), '1.0.1', true);
...
function admin_style() {
    wp_register_style('admin-styles', get_template_directory_uri() . '/css/admin.css', array(), mt_rand(), 'all');
