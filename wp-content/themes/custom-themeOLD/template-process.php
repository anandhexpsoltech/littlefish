<?php /* Template Name: Our Process */ get_header(); ?>
	...
	<div class="main-container" style="background-image: url(<?php the_field('header_background'); ?>)">
		...
		<?php if(get_field('process_box_1_content')): ?>
            <div class="box-wrap last animated wow fadeIn">
                <div class="wrapper overflow">
                    <?php if(get_field('process_box_1_title')): ?>
                        <div class="title">
                            <h2>
                                <?php the_field('process_box_1_title'); ?>
                            </h2>
                        </div>
                    <?php endif; ?>

                    <div class="content">
                        <?php the_field('process_box_1_content'); ?>

                        <?php if(get_field('process_box_1_link')): ?>
                            <a class="btn-more" href="<?php the_field('process_box_1_link'); ?>">
