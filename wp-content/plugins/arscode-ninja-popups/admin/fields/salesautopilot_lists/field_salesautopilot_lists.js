jQuery(document).ready(function(){
	jQuery('.salesautopilot_lists_gl').click(function(){
		...
		jQuery.ajax({
			...
			data:{
				...
				'ml_salesautopilot_apikey': jQuery('#ml_salesautopilot_apikey').val(),
				'ml_salesautopilot_apisecret': jQuery('#ml_salesautopilot_apisecret').val()
			},
			dataType: 'JSON',
			type: 'POST',
