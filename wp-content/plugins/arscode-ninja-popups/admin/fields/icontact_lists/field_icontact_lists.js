jQuery(document).ready(function(){
	jQuery('.icontact_lists_gl').click(function(){
		...
		jQuery.ajax({
			...
			data:{
				...
				'ml_ic_username': jQuery('#ml_ic_username').val(),
				'ml_ic_addid': jQuery('#ml_ic_addid').val(),
				'ml_ic_apppass': jQuery('#ml_ic_apppass').val()
			},
			dataType: 'JSON',
			type: 'POST',
