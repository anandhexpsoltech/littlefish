jQuery(document).ready(function(){
	jQuery('.elasticemail_lists_gl').click(function(){
		...
		jQuery.ajax({
			...
			data:{
				...
				'ml_elasticemail_apikey': jQuery('#ml_elasticemail_apikey').val(),
				'ml_elasticemail_apisecret': jQuery('#ml_elasticemail_apisecret').val()
			},
			dataType: 'JSON',
			type: 'POST',
