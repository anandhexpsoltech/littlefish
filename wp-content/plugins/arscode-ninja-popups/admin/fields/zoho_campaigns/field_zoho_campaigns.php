...
class SNP_NHP_Options_zoho_campaigns extends SNP_NHP_Options
{
    ...
    public function render()
    {
        ...
        $this->field['options'] = snp_ml_get_zoho_campaigns();
        ...
        if(!isset($this->field['meta']) || !$this->field['meta']) {
            echo '<input type="button" rel-id="' . $this->field['id'] . '" class="button zoho_campaigns_gl" name="" value="Grab Campaigns" />';
        }
    ...
    {
        wp_enqueue_script(
            'nhp-opts-field-zoho_campaigns-js', SNP_NHP_OPTIONS_URL . 'fields/zoho_campaigns/field_zoho_campaigns.js', array('jquery'), time(), true
        );
    }
}