jQuery(document).ready(function(){
	jQuery('.rocketresponder_lists_gl').click(function(){
		...
		jQuery.ajax({
			...
			data:{
				...
				'ml_rocketresponder_apipublic': jQuery('#ml_rocketresponder_apipublic').val(),
				'ml_rocketresponder_apiprivate': jQuery('#ml_rocketresponder_apiprivate').val()
			},
			dataType: 'JSON',
			type: 'POST',
