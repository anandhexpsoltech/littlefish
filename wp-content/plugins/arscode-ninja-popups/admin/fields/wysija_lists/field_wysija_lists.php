...
class SNP_NHP_Options_wysija_lists extends SNP_NHP_Options
{
	...
	public function render()
	{
		...
		if (!isset($this->field['meta'])) {
		    echo '<input type="button" rel-id="' . $this->field['id'] . '" class="button wysija_lists_gl" name="" value="Grab Lists" />';
		}
	...
	{
		wp_enqueue_script(
			'nhp-opts-field-wysija_lists-js', SNP_NHP_OPTIONS_URL . 'fields/wysija_lists/field_wysija_lists.js', array('jquery'), time(), true
		);
	}
}