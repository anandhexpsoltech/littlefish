jQuery(document).ready(function(){
	jQuery('.sendlane_lists_gl').click(function(){
		...
		jQuery.ajax({
			...
			data:{
				...
				'ml_sendlane_apikey': jQuery('#ml_sendlane_apikey').val(),
				'ml_sendlane_hash': jQuery('#ml_sendlane_hash').val(),
				'ml_sendlane_subdomain': jQuery('#ml_sendlane_subdomain').val()
			},
			dataType: 'JSON',
			type: 'POST',
