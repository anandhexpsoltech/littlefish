jQuery(document).ready(function(){
	jQuery('.campaigner_lists_gl').click(function(){
		...
		jQuery.ajax({
			...
			data:{
				...
				'ml_campaigner_username': jQuery('#ml_campaigner_username').val(),
				'ml_campaigner_password': jQuery('#ml_campaigner_password').val(),
			},
			dataType: 'JSON',
			type: 'POST',
