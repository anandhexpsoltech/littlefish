jQuery(document).ready(function(){
	jQuery('.mailerlite_lists_gl').click(function(){
		...
		jQuery.ajax({
			...
			data:{
				...
				'ml_mailerlite_apikey': jQuery('#ml_mailerlite_apikey').val(),
				'ml_mailerlite_apisecret': jQuery('#ml_mailerlite_apisecret').val()
			},
			dataType: 'JSON',
			type: 'POST',
