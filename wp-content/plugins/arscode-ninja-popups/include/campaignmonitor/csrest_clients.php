...
if (!class_exists('CS_REST_Clients'))
{
	...
	class CS_REST_Clients extends CS_REST_Wrapper_Base
	{
		 ...
		 * @access public
		 */
		function __construct($client_id, $api_key, $protocol = 'https', $debug_level = CS_REST_LOG_NONE, $host = 'api.createsend.com', $log = NULL, $serialiser = NULL, $transport = NULL)
		{

			parent::__construct($api_key, $protocol, $debug_level, $host, $log, $serialiser, $transport);
