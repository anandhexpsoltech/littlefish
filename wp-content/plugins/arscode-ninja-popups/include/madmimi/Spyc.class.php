 ...
 */
  public function load ($input) {
    return $this->privateLoadString($input);
  }
 ...
 */
  ...
  public static function YAMLLoadString($input) {
    $Spyc = new Spyc;
    return $Spyc->privateLoadString($input);
  }
...
// LOADING FUNCTIONS
  ...
  private function privateLoad($input) {
    $Source = $this->loadFromSource($input);
    return $this->loadWithSource($Source);
  }

  private function privateLoadString($input) {
